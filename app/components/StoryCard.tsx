...
/** 인스타 스토리용 9:16 SVG 문자열 생성 (540x960) */
export function buildStorySvg(d: StoryCardData): string {
  ...
  <circle cx="80" cy="140" r="46" fill="#FBBF24" opacity="0.45"/>
  <circle cx="470" cy="220" r="30" fill="#F43F5E" opacity="0.25"/>
  <circle cx="455" cy="800" r="60" fill="#FBBF24" opacity="0.3"/>
  <circle cx="60" cy="700" r="24" fill="#F43F5E" opacity="0.2"/>
  <text x="270" y="120" text-anchor="middle" font-size="44" font-weight="900" font-family="sans-serif" fill="#E11D48">나잘알</text>
  <text x="270" y="160" text-anchor="middle" font-size="20" font-family="sans-serif" fill="#7c4a3a">친구들은 나를 얼마나 잘 알까?</text>
  <rect x="70" y="210" width="400" height="420" rx="36" fill="#ffffff"/>
  <text x="270" y="272" text-anchor="middle" font-size="26" font-weight="700" font-family="sans-serif" fill="#2A1E1A">${name}의 점수</text>
  <text x="270" y="392" text-anchor="middle" font-size="120" font-weight="900" font-family="sans-serif" fill="#E11D48">${d.score}점</text>
  <text x="270" y="440" text-anchor="middle" font-size="22" font-family="sans-serif" fill="#7c4a3a">/ 100점</text>
  <rect x="130" y="470" width="280" height="64" rx="32" fill="#FFF1F3"/>
  <text x="270" y="512" text-anchor="middle" font-size="30" font-weight="800" font-family="sans-serif" fill="#BE123C">${grade.emoji} ${esc(grade.label)}</text>
  <text x="270" y="580" text-anchor="middle" font-size="20" font-family="sans-serif" fill="#7c4a3a">너도 나를 맞혀봐!</text>
  <rect x="110" y="660" width="320" height="88" rx="24" fill="url(#btn)"/>
  <text x="270" y="715" text-anchor="middle" font-size="28" font-weight="800" font-family="sans-serif" fill="#ffffff">친구들 시험하기</text>
